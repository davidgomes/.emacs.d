...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (elpy restart-emacs git-commit flycheck nyan-mode django-mode col-highlight auto-complete))))
...
;; List all packages
(setq required-packages
      '(nyan-mode auto-complete popup django-mode elpy pyvenv highlight-indentation find-file-in-project company f dash s find-file-in-project fuzzy gccsense gist gh logito pcache go-mode handlebars-mode haskell-mode helm-flycheck helm async flycheck let-alist pkg-info epl dash dash highlight-indentation idomenu iedit jabber jinja2-mode js2-mode json-mode json-snatcher json-reformat json-reformat json-snatcher jsx-mode less-css-mode let-alist logito lua-mode magit magit-popup dash git-commit with-editor dash dash with-editor dash magit-popup dash moe-theme nav nose paredit pcache pkg-info epl popup powerline processing-mode pyvenv quack s sass-mode haml-mode scheme-complete scss-mode solarized-theme dash vimrc-mode web-mode with-editor dash noctilux-theme helm-projectile neotree))
